...
(function attachI18nResources(global) {
  ...
  const RESOURCES = {
    pl: {
      ...
      assistantMentorDatabasesToast: "W pełnej wersji asystent otworzy listę zadań z baz danych i terminy oddania.",
      assistantMentorSeminarToast: "W pełnej wersji asystent otworzy notatkę seminaryjną albo miejsce jej przygotowania.",
    ...
    en: {
      ...
      assistantMentorDatabasesToast: "In the full version, the assistant will open the database assignments list and deadlines.",
      assistantMentorSeminarToast: "In the full version, the assistant will open the seminar note or the place to prepare it.",
